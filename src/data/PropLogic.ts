 ...
 */
class PropLogic {
	public static useProp(proptye: number, ellocation: number) {
		switch (proptye) {
			case 0: PropLogic.tongse(ellocation);
				break;
			case 1: PropLogic.zhandan(ellocation);
				break;
			case 2: PropLogic.zhenghang(ellocation);
				break;
			case 3: PropLogic.zhenglie(ellocation);
				break;
			case 4: PropLogic.chanzi(ellocation);
				break;
		}
	}
